...
namespace Neith.Logger.Model
{
    ...
    public class NeithLog : ReactiveValidatedObject, IEquatable<NeithLog>
    {
        ...
        private DateTimeOffset _UtcTime = default(DateTimeOffset);
        ...
        private string _Collector = default(string);
