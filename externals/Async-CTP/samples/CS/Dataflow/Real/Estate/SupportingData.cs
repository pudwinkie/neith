...
// 
//  File: SupportingData.cs
//
//--------------------------------------------------------------------------

namespace RealEstateSimulation
{
    /// <summary>Provides supporting data for the simulation.</summary>
    internal static class SupportingData
    {
        /// <summary>Descriptions used to manufacture new listings.</summary>
        internal static string[] PropertyAdjectives = new[] { "Cute", "Small", "Mid-sized", "Large", "Gigantic" };

        /// <summary>Types of dwellings.</summary>
        internal static string [] PropertyTypes = new[] 
        { 
            "A-frame", "Addison", "Airey", "American Colonial", "Colonial Cape Cod", 
            "Dutch Colonial", "French Colonial", "Georgian Colonial", "German Colonial", 
            "New England Colonial", "Spanish Colonial", "Barndominium", "Bay-and-gable", 
            "Bungalow", "Cape Code", "Cape Dutch", "Castle", "Chalet bungalow", "Chattel", 
            "Conch House", "Cottage", "American Craftsman", "Creole cottage", "Deck House", 
            "Farmhouse", "American Foursquare", "Gablefront", "Gambrel", "Geodesic dome",
            "I-house", "Igloo", "Izba", "Konak", "Laneway", "Log Cabin", "Lustron", "Manor House", 
            "Mansion", "McMansion", "Microhouse", "Mudhif", "Patio House", "Ranch", "Queenslander",
            "Saltbox", "Split-level", "Shack", "Shotgun House", "Souterrain", "Stilt House", "Snout House", 
            "Storybook House", "Tipi", "Tree House", "Trullo", "Tudor Revival", "Tuscan", "Victorian", 
            "Villa", "Duplex", "Apartment", "Two-Family", "Two Decker", "Barracks", "Brownstone",
            "Choultry", "Condominium", "Flat", "2-Flat", "3-Flat", "Four-plus-One", "Garalow", 
            "Garden Apartment", "Live Work", "Loft", "Maisonete", "Penthouse", "Plattenbau", 
            "Rowhouse", "Shophouse", "Studio", "Houseboat"
        };

        /// <summary>Common first names.</summary>
        ...
        {            
            ...
            "Autumn", "Ava", "Avery", "Avner", "Ayanna", "Ayden", "Ayla", "Baby", 
            ...
            "Ikaika", "Imani", "India", "Ira", "Irene", "Iris", 
            ...
            "Lorraine", "Lorrie", "Louis", "Louise", "Lucas", "Lucia", "Lucian", "Lucy", 
            "Luis", "Luke", "Lydia", "Lyle", "Lynda", "Lynette", "Lynn", 
            "Lynne", "Mackenzie", "Macy", "Maddison", "Madeleine", "Madeline", "Madelyn", 
            "Madison", "Madisyn", "Mads", "Maeve", "Maggie", "Mahealani", "Mahina", "Maia", 
            ...
            "Randal", "Randall", "Randi", "Raquel", "Rashad", "Raul", 
            ...
            "Tyrone", "Tyson", "Valeria", "Valerie", "Vanessa", 
