...
Friend Class SupportingData
    ''' <summary>Descriptions used to manufacture new listings.</summary>
    Friend Shared ReadOnly PropertyAdjectives As String() = {"Cute", "Small", "Mid-sized", "Large", "Gigantic"}

    ''' <summary>Types of dwellings.</summary>
    Friend Shared ReadOnly PropertyTypes As String() = {
    ...
    Friend Shared ReadOnly PeopleNames As String() = {
