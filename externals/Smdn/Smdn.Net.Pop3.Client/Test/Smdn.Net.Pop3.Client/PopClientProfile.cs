...
namespace Smdn.Net.Pop3.Client {
  [TestFixture]
  public class PopClientProfileTests {
    [Test]
    public void TestClone()
    {
      var original = new PopClientProfile(new Uri("pop://user@localhost/"));
    ...
    public void TestSerializeBinary()
    {
      ...
      Smdn.Net.TestUtils.SerializeBinary(original, delegate(PopClientProfile deserialized) {
