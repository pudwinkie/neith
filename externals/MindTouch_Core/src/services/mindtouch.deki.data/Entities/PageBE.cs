...
namespace MindTouch.Deki.Data {
    ...
    public class PageBE {
        ...
        public virtual PageBE Copy() {
            ...
            p.IsNew = IsNew;
            p.IsHidden = IsHidden;
            p.IsRedirect = IsRedirect;
            p.Language = Language;
            p.Meta = Meta;
            p.MinorEdit = MinorEdit;
            p.ParentID = ParentID;
            p.RestrictionID = RestrictionID;
            p.Revision = Revision;
    ...
    public class PageWrapperBE : ResourceBE {

        // -- Fields -- 
        PageBE _page = null;

        // -- Constructors -- 
        public PageWrapperBE(PageBE page) {
            _page = page;
            ResourceType = Type.PAGE;
        }
