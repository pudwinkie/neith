...
namespace MindTouch.Deki.Script.Compiler {
    internal class DekiScriptExpressionOptimizer : IDekiScriptExpressionVisitor<DekiScriptExpressionEvaluationState, DekiScriptExpression> {
        ...
        public DekiScriptExpression Visit(DekiScriptBlock expr, DekiScriptExpressionEvaluationState state) {
            return DekiScriptExpression.Block(expr.Location, expr.Value.VisitWith(this, state));
        }
