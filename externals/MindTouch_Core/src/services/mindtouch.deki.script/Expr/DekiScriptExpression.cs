...
namespace MindTouch.Deki.Script.Expr {
    ...
    public abstract class DekiScriptExpression {
        ...
        public static DekiScriptLiteral Constant(XUri value) {
            return Constant(value, new DekiScriptLiteral[0]);
        }
        ...
        public static DekiScriptExpression Block(Location location, DekiScriptExpression value) {
            return new DekiScriptBlock(value) { Location = location };
        }
