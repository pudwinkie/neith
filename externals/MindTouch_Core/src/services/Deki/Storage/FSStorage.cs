    ...
    public class FSStorage : IStorageProvider{
        ...
        public FSStorage(XDoc configuration) {           
            ...
            if(string.IsNullOrEmpty(_path)) {
                throw new ArgumentException(DekiResources.PATH_CONFIG_MISSING);
            }
        ...
        private void PutFileInternal(string filename, StreamInfo file, bool overwrite) {
            using(file) {
                ...
                if(!Utils.EnsureDirectoryExists(directory)) {
                    ...
                    throw new DreamInternalErrorException(string.Format(DekiResources.CANNOT_CREATE_FILE_DIRECTORY, directory));
                }
                ...
                try {
                    ...
                    throw new DreamInternalErrorException(string.Format(DekiResources.CANNOT_SAVE_FILE_TO, filename, e.Message));
                }
            }
        }
    }
