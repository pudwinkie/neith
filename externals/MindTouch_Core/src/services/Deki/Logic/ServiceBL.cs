...
namespace MindTouch.Deki.Logic {
    public static class ServiceBL {
        ...
        public static ServiceBE StopService(uint servicedId, bool dekiShutdown) {
            ServiceBE service = DbUtils.CurrentSession.Services_GetById(servicedId);
        ...
        public static IEnumerable<ServiceBE> RestartServices() {
            List<ServiceBE> result = new List<ServiceBE>();
        ...
        public static ServiceBE RetrieveLocalAuthService() {
            ...
            if(!StringUtil.EqualsInvariantIgnoreCase(service.SID.Trim(), SID_FOR_LOCAL)) {
                throw new DreamAbortException(DreamMessage.InternalError(string.Format(DekiResources.EXPECTED_SERVICE_TO_HAVE_SID, SID_FOR_LOCAL)));
            }
            return service;
        }
        ...
        public static void EnsureServiceAdministrationAllowed() {
            if(DekiContext.Current.Instance.LimitedAdminPermissions)
                throw new DreamAbortException(DreamMessage.NotImplemented(DekiResources.SERVICE_ADMINISTRATION_DISABLED));
        }
        ...
        private static void ParseServiceXml(XDoc serviceDoc, out uint? serviceId, out string SID, out string description, out bool? serviceEnabled,
            ...
            default:
                throw new DreamBadRequestException(DekiResources.SERVICE_UPDATE_TYPE_INVALID);
            }
            ...
            case "remote":
                ...
                break;
            default:
                throw new DreamBadRequestException(DekiResources.SERVICE_UNEXPECTED_INIT);
            }

            SID = serviceDoc["sid"].AsText;
            description = serviceDoc["description"].AsText;
            if(string.IsNullOrEmpty(description)) {
                throw new DreamBadRequestException(DekiResources.SERVICE_MISSING_DESCRIPTION);
            }
            ...
            case "":
                ...
                break;
            default:
                throw new DreamBadRequestException(DekiResources.SERVICE_INVALID_STATUS);
            }
