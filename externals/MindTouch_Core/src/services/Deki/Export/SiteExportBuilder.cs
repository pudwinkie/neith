                ...
                try {
                    if(exportXml.HasName("page")) {
                        ...
                        if((null == page) || (0 == page.ID)) {
                            throw new DreamNotFoundException(DekiResources.CANNOT_FIND_REQUESTED_PAGE);
                        }
                        ...
                        if(!exportXml["@id"].IsEmpty) {
                            ...
                            if(0 < fileId) {
                                ...
                                if(resourceId > 0) {
                                    file = AttachmentBL.Instance.GetResource(resourceId, AttachmentBE.HEADREVISION);
                                }
                            }
                        }
                        if(null == file) {
                            throw new DreamNotFoundException(DekiResources.COULD_NOT_FIND_FILE);
                        }
