...
namespace MindTouch.Deki.Script.Tests.ScriptTests {
    public class DekiScriptTester {
        ...
        //--- Fields ---
        public readonly TestDekiScriptRuntime Runtime = new TestDekiScriptRuntime();
        //public readonly DekiScriptEnv Env;
        //public readonly DekiScriptEnv SafeEnv;

        //--- Constructors ---
        public DekiScriptTester() {
            //Env = Runtime.CreateEnv();
            //SafeEnv = Runtime.CreateEnv();
        }
        ...
        //public void AttachFunctionToEnv(string functionName, MethodInfo method, DekiScriptNativeInvocationTarget.Parameter[] parameters) {
        //    AttachFunctionToEnv(functionName, method, parameters, false);
        //}

        //public void AttachFunctionToSafeEnv(string functionName, MethodInfo method, DekiScriptNativeInvocationTarget.Parameter[] parameters) {
        //    AttachFunctionToEnv(functionName, method, parameters, true);
        //}

        //public void AttachFunctionToEnv(string functionName, MethodInfo method, DekiScriptNativeInvocationTarget.Parameter[] parameters, bool safe) {
        //    var env = safe ? SafeEnv : Env;
        ...
        //    Runtime.Functions[functionPointer] = function;
        //    env.Vars.AddNativeValueAt(function.Name, functionPointer);
        //}
