...
namespace MindTouch.Deki.Tests.SearchTests {
    ...
    public class SearchBLTests {
        ...
        public void Can_build_Filename_query_with_dash_in_filename() {
            ...
            // Assert
            Assert.AreEqual("+(filename:foo\\-bar* extension:.foo\\-bar) +type:(document image binary)", query.LuceneQuery);
        }
        ...
        public void Can_use_custom_constraint_on_Filename_query() {
            ...
            // Assert
            Assert.AreEqual("+(filename:foo* extension:.foo) +type:(document image binary) +custom", query.LuceneQuery);
        }
...
<search querycount=""1"" ranking=""adaptive"" queryid=""123"" count=""1"">
  ...
  <result>
    ...
    <type>page</type>
        ...
        [Test]
        [ExpectedException(typeof(MindTouchLicenseInvalidOperationException))]
