...
namespace MindTouch.Deki.Tools {
    internal class Program {
        ...
        static void Main(string[] args) {
            ...
            AttachmentBE[] attachments = LoadAllAttachments();
        ...
        private static AttachmentBE[] LoadAllAttachments() {
            ResourceBE[] resources = DbUtils.CurrentSession.Resources_GetByQuery(null, ResourceBE.Type.UNDEFINED, new List<ResourceBE.Type>() { ResourceBE.Type.FILE }, null, DeletionFilter.ANY, false, null, null).ToArray();
