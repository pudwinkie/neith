...
<div id="deki-page-rating-comment">
	<form class="special-page-form">
		...
		<div class="field">
			<?php echo DekiForm::singleInput('textarea', 'rating'); ?>
		</div>
		<div id="footer">
			<div class="buttons-bottom">
				<?php echo DekiForm::singleInput('button', 'cancel', '', array('class' => 'secondary'), wfMsg('Page.ContentRating.button.close')); ?>
				<?php echo DekiForm::singleInput('button', 'submit', 'true', null, wfMsg('Page.ContentRating.button.add')); ?>
			</div>
		</div>
	</form>
</div>
