...
class SpecialSearch extends SpecialPagePlugin
{
	 ...
	 * @param bool $showFilters - render the search filters
	 * @return string
	 */
	protected function form($queryId = null, $showFilters = false)
	{
		...
		$View->set('form.filters', $showFilters);
	...
	protected function search()
	{
		...
		$View->setRef('form.footer', $this->form($Search->getQueryId()));
	...
	protected function getQueryParams($queryId, $sortField = null)
	{
		...
		$get = array(
			...
			'ns' => $this->Request->getVal('ns'),
			'language' => $this->Request->getVal('language'),
			'sort' => $this->Request->getVal('sort'),
			'qid' => $this->Request->getVal('qid'),
