...
$wgConfigMap = 
	array(
		...
		'wgAnonView' => 'security/allow-anon-view', //only used for mindtouch deki hosted; this is actually a misnomer; it should have been named block-anon-view
		'wgAccountLevel' => 'site/account-level', //only used for mindtouch deki hosted
		...
		'wgFCKToolbarSet' => 'editor/toolbar', 
