...
class EditPage {
	...
	function editForm( $formtype, $firsttime = false , $ajax = false ) 
	{
		...
		$html = 
			'<div class="b-body">'
				.'<form id="editform"'.($wgRequest->getVal('baseuri') ? ' target="_self"': '').' name="editform" method="post" action="'.$this->mTitle->escapeLocalURL( $formQueryParams, true ).'" enctype="multipart/form-data">'
