...
(function()
{
	...
	var imageCmd =
	{
		...
		exec : function( editor )
		{
			...
			if ( !( imageElement && imageElement.getName() == 'img' && !imageElement.getAttribute( '_cke_protected_html' ) ) &&
					!( imageElement && imageElement.getName() == 'input' && imageElement.getAttribute( 'type' ) && imageElement.getAttribute( 'type' ) == 'image' ) )
				imageElement = null;
				...
				params =
					{
						...
						'sSrc' : imageElement.getAttribute( '_cke_saved_src' ) || imageElement.getAttribute( 'src' ),
		...
		_ :
		{
			insertImage : function( params )
			{
				...
				try
				{
					...
					imageElement.setAttribute( '_cke_saved_src', params.sSrc );
					...
					if ( params.sFullSrc && params.sFullSrc.length > 0 )
					{
						...
						linkElement.setAttribute( '_cke_saved_href', params.sFullSrc ) ;
