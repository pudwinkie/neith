...
(function()
{
	...
	CKEDITOR.dialog = function( editor, dialogName )
	{
		...
		function changeFocus( forward )
		{
			...
			{
				/**
				 * Firebug stops on this error
				 * @author MindTouch
				 */
				focusList[ current ] && focusList[ current ].getInputElement().$.blur();
//				focusList[ current ].getInputElement().$.blur();
	...
	CKEDITOR.tools.extend( CKEDITOR.dialog,
		 ...
		 */
		{
			 ...
			 */
			add : function( name, dialogDefinition, override )
			// add : function( name, dialogDefinition )
			{
				// Avoid path registration from multiple instances override definition.
				if ( !this._.dialogDefinitions[name]
					|| override === true // @author MindTouch | allow to override definition
