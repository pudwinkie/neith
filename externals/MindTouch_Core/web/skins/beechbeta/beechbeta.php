...
class Skinbeechbeta extends SkinTemplate
{
	const TEMPLATE_NAME = 'beechbeta';
	...
	function initPage(&$out) 
	{
		...
		$this->skinname  = 'beechbeta';
		$this->stylename = 'beechbeta';
		
		if (isset($wgBeechTemplate))
		{
			require_once('skins/'. Skinbeechbeta::TEMPLATE_NAME .'/'. $wgActiveSkin .'/template.php');
			$this->template = $wgBeechTemplate;
		}
		else
		{
			$this->template = 'beechbetaTemplate';
		}
	}
}

class beechbetaTemplate extends QuickTemplate
{
	public function execute()
	{
		...
		require_once('skins/'. Skinbeechbeta::TEMPLATE_NAME .'/'. $wgActiveSkin .'/html.php');  
	}
