...
INSERT INTO `pages` (`page_namespace`, `page_title`, `page_text`, `page_comment`, `page_timestamp`, `page_touched`, `page_toc`, `page_tip`, `page_parent`, `page_restriction_id`, `page_content_type`, `page_display_name`) VALUES 
	(101, '', '{{ wiki.tree("Special:") }}', '', '', '',  '', 'Special page', 0, 2, 'application/x.deki-text', ''),
...
INSERT into `pages` (`page_namespace`, `page_title`, `page_text`, `page_touched`, `page_user_id`, `page_timestamp`, `page_display_name`) 
	VALUES (0, '', '<p>Here are some tips on getting started with this wiki:</p> 
	  ...
	  <h2>Contribute content</h2> 
		  ...
		  </div>', 0, 1, '20071103195811', '');
	
INSERT into `pages` (`page_namespace`, `page_title`, `page_text`, `page_touched`, `page_user_id`, `page_timestamp`, `page_display_name`) VALUES
	(0, 'Welcome', '<p>Here are some tips on administering this wiki:</p><div style="width:580px;">
	  ...
	  </div>{{ wiki.page(&quot;&quot;) }}', 0, 1, '20071103195811', '');
...
INSERT INTO `users` (`user_name`,`user_real_name`,`user_password`,`user_newpassword`,`user_email`,`user_touched`,`user_token`,`user_role_id`,`user_active`,`user_service_id`, `user_builtin`) VALUES
