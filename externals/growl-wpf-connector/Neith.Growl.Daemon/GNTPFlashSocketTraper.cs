...
namespace Neith.Growl.Daemon
{
    ...
    /// </summary>
    class GNTPFlashSocketTraper : GNTPRequestTraper
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GNTPFlashSocketTraper"/> class.
        /// </summary>
        ...
        public GNTPFlashSocketTraper(AsyncSocket socket, bool allowFlash)
        {
            this.socket = socket;
