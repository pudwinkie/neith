...
namespace Neith.Growl.Daemon
{
    ...
    public class SubscriptionConnector : ConnectorBase, IDisposable
    {
        ...
        /// </summary>
        public delegate void ResponseEventHandler(ISubscriptionResponse response);
        ...
        /// <summary>
        /// The <see cref="ISubscriber"/> information
        /// </summary>
        ...
        public SubscriptionConnector(ISubscriber subscriber, string password, string hostname)
        ...
        public SubscriptionConnector(ISubscriber subscriber, string password, string hostname, int port)
        ...
        protected override void OnResponseReceived(string responseText, object state)
        {
            ...
            var response = mp.Parse(responseText, out cd, out headers);

            var sr = SubscriptionResponse.FromResponse(response, headers);
        ...
        private void ResetTimerBasedOnResponse(ISubscriptionResponse sr)
        {
        ...
        {
            var sr = SubscriptionResponse.FromResponse(response, null);
            ResetTimerBasedOnResponse(sr);
            this.OnErrorResponse(sr);
        }
