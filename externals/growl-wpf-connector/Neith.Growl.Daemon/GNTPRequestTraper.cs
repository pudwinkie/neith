...
namespace Neith.Growl.Daemon
{
    ...
    /// </summary>
    public abstract class GNTPRequestTraper
    {
        /// <summary>
        /// Represents the method that will handle the <see cref="Error"/> event.
        /// </summary>
        public delegate void GNTPRequestReaderErrorEventHandler(IError error);
        ...
        public delegate void GNTPRequestReaderMessageParsedEventHandler(IGNTPRequest request);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GNTPRequestTraper"/> class.
        /// </summary>
        public GNTPRequestTraper()
        {
        ...
        /// </summary>
        /// <param name="request">The <see cref="IGNTPRequest"/>.</param>
        protected void OnMessageParsed(IGNTPRequest request)
        {
