...
namespace Neith.Growl.Connector
{
    ...
    public class MessageBuilder : MessageSection
    {
        ...
        public MessageBuilder(ResponseType messageType, Key key, Cryptography.HashAlgorithmType keyHashAlgorithm, Cryptography.SymmetricAlgorithmType encryptionAlgorithm)
            : this("-" + messageType.ToString(), key, false, Cryptography.HashAlgorithmType.SHA1, Cryptography.SymmetricAlgorithmType.PlainText)
        {
        }
         * */
        ...
        public override byte[] GetBytes()
        {
            ...
            foreach (BinaryData data in allBinaryData)
            {
                if (data != null && data.Data != null)
                {
                    ...
                    section.AddHeader(new Header(HeaderKeys.RESOURCE_IDENTIFIER, data.ID));
                    section.AddHeader(new Header(HeaderKeys.RESOURCE_LENGTH, er.EncryptedBytes.Length.ToString()));
                    section.AddBlankLine();
    ...
    public class MessageSection
    {
        ...
        /// <summary>
        /// Adds a <see cref="IHeader"/> to the section.
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        /// <param name="header">The <see cref="IHeader"/> to add</param>
