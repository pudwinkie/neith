...
namespace Neith.Growl.Connector
{
    ...
    public sealed class Cryptography
    {
        ...
        /// <summary>
        /// Hashes the supplied input using using the SHA1 hashing algorithm
        /// </summary>
        /// <remarks>
        ...
        /// <returns cref="string">The hex-encoded SHA1-hashed value</returns>
        public static string ComputeHash(string inputString)
        {
            ...
            {
                // hash it
                string hash = ComputeHash(inputString, HashAlgorithmType.SHA1);
                return hash;
            }
            catch (Exception ex)
            {
