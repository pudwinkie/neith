...
namespace Neith.Growl.Connector
{
    ...
    /// </summary>
    public class CallbackDataBase : ICallbackDataBase
    {
        /// <summary>
        ...
        public static ICallbackDataBase FromHeaders(HeaderCollection headers)
        {
            string data = headers.GetHeaderStringValue(HeaderKeys.NOTIFICATION_CALLBACK_CONTEXT, true);
            string type = headers.GetHeaderResourceValue(HeaderKeys.NOTIFICATION_CALLBACK_CONTEXT_TYPE, true);
