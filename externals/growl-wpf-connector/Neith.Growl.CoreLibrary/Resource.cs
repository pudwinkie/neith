...
namespace Neith.Growl.CoreLibrary
{
    ...
    public class Resource
    {
        ...
        /// <summary>
        /// Converts the value of a <see cref="BitmapImage"/> object to a <see cref="Resource"/>
        /// </summary>
        /// <param name="image"><see cref="BitmapImage"/></param>
        /// <returns><see cref="Resource"/></returns>
        static public implicit operator Resource(BitmapImage image)
        {
        ...
        /// <summary>
        /// Converts a <see cref="Resource"/> to a <see cref="BitmapImage"/>
        /// </summary>
        /// <param name="resource"><see cref="Resource"/></param>
        /// <returns><see cref="BitmapImage"/></returns>
        static public implicit operator BitmapImage(Resource resource)
        {
            if (resource != null)
            {
