...
namespace Neith.Growl.CoreLibrary
{
    ...
    public class BinaryData
    {
        ...
        /// </summary>
        private static HashAlgorithm genHash = SHA1CryptoServiceProvider.Create();
        ...
        /// <remarks>
        /// This implementation generates the SHA1 hash of the data and
