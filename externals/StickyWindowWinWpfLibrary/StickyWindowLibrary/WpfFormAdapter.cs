...
namespace StickyWindowLibrary
{
    public class WpfFormAdapter : IFormAdapter
    {
        ...
        public object FormObject { get { return _window; } }
        ...
        public Size MaximumSize
        {
            get
            {
                if (_window.MaxWidth.IsNormal() && _window.MaxHeight.IsNormal()) {
                    return new Size(Convert.ToInt32(_window.MaxWidth), Convert.ToInt32(_window.MaxHeight));
                }
                return new Size();
            }
            set
        ...
        public Size MinimumSize
        {
            get
            {
                if (_window.MinWidth.IsNormal() && _window.MinHeight.IsNormal()) {
                    return new Size(Convert.ToInt32(_window.MinWidth), Convert.ToInt32(_window.MinHeight));
                }
                return new Size();
            }
            set
