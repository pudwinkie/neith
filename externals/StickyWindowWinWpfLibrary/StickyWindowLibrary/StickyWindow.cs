...
namespace Blue.Windows
{
    ...
    /// </summary>
    internal class StickyWindow : System.Windows.Forms.NativeWindow
    {
        /// <summary>
        /// Global List of registered StickyWindows
        /// </summary>
        private readonly static List<IFormAdapter> GlobalStickyWindows = new List<IFormAdapter>();
        ...
        /// 外部窓をスナップ対象に登録します。
        /// </summary>
        /// <param name="frmExternal">外部フォームアダプタ</param>
        public static void Register(IFormAdapter frmExternal)
        {
        ...
        public static void Unregister(IFormAdapter frmExternal)
        {
        ...
        /// </summary>
        /// <param name="frmExternal">External window that will was used as reference</param>
        private static void UnregisterImpl(object formObject)
        {
            var form = GlobalStickyWindows
                .Where(a => a.FormObject == formObject)
                .FirstOrDefault();
            if (form == null) return;
            Unregister(form);
        }
        ...
        /// 外部窓をスナップ対象に登録します。
        /// </summary>
        /// <param name="frmExternal">System.Windows.Forms.Form</param>
        public static void Register(Form frmExternal)
        {
            Register(new WinFormAdapter(frmExternal));
        }
        ...
        /// </summary>
        /// <param name="frmExternal">System.Windows.Forms.Form</param>
        public static void Unregister(Form frmExternal)
        {
            UnregisterImpl(frmExternal);
        }
        ...
        public static void Register(System.Windows.Window winExternal)
        {
            Register(new WpfFormAdapter(winExternal));
        }
        ...
        /// </summary>
        /// <param name="winExternal">System.Windows.Window</param>
        public static void Unregister(System.Windows.Window winExternal)
        {
            UnregisterImpl(winExternal);
        }
